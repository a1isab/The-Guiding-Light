-- Fix RLS policies for multi-role support (text[] column)
-- Replaces get_user_role() = 'admin' with get_user_role() @> ARRAY['admin']
-- Replaces get_user_role() IN ('teacher', 'admin') with get_user_role() && ARRAY['teacher', 'admin']

-- ============================================================
-- SECTION 1: Fix migration-003-rbac.sql / migration-009 policies
-- ============================================================
...
-- Quizzes (legacy table if exists)
...
-- ============================================================
-- SECTION 6: Fix migration-011-enhanced-lessons.sql policies
-- ============================================================
...
-- ============================================================
-- SECTION 7: Fix migration-013-teacher-progress.sql policies
-- ============================================================
