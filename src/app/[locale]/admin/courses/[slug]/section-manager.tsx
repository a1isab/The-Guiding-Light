                ...
                {newLesson?.sectionId === section.id ? (
                  <div className="flex items-center gap-2 px-5 py-3 bg-zinc-900/30">
                    ...
                    <input
                      ...
                      className="w-28 rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-sm text-zinc-100 focus:border-emerald-500 focus:outline-none"
                    />
                    <button
        ...
        <div className="rounded-2xl border border-zinc-800 bg-[#111111] p-5">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <input
              ...
              className="w-32 rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 focus:border-emerald-500 focus:outline-none"
            />
            <input
              type="number"
              placeholder="Order"
